...
if(isset($_POST)){
	...
	$game_value_list = "'".$name."', '".$description."'";
	$gameid = $mainClassObj->insertSchema($game_table, $game_table_fields, $game_value_list);
	...
	header("Location: ".GAME_URL."leaderboard.php?option=add_success");
}
?>